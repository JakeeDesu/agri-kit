...
export const AgriEdgeProducts = () => {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-start overflow-y-scroll p-4  ">
            <div className={`relative grid grid-cols-1 md:grid-cols-2 gap-8 py-8 w-full max-w-4xl h-full rounded-sm ring-1 d:ring-0 ring-white shadow-xl bg-black/5 d:bg-black/0 backdrop-blur-lg d:backdrop-blur-none   transition-all duration-1000 ease-in-out overflow-y-scroll `}>
    ...
    return (
        <div className=" h-full w-full flex justify-center items-center">
            <div className="relative h-full w-full flex justify-center items-center cursor-pointer ">
                <div
                    className="relative h-48 w-48  flex flex-col justify-start items-center p-4 m-10 bg-white rounded-full transition duration-200 ease-in-out shadow-lg hover:shadow-2xl hover:scale-105  "
